...
const Eligibility = () => {
    return (
        ...
        <div className='mt-5 mb-5 mx-5' style={{display:"flex",justifyContent:"center",alignItems:"center",flexWrap:"wrap"}}>
            <div class="mx-5 mb-2" style={{display:"flex",flexDirection:"column" ,justifyContent:"center",alignItems:"center", boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.5)',width:"300px",borderRadius:"8px",borderTop:"2px solid blue" }}>
